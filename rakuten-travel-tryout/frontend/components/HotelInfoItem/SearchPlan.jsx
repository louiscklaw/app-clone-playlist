...
function RoomPlan({ plan }) {
  return (
    <>
      <div class="row">
        <div style={{ width: '65%' }}>
          <Typography variant="body1" fontWeight="bold" color={color.accentGreen}>
            {plan.name}
          </Typography>
        ...
        <div style={{ flexGrow: 1 }}>
          <Stack direction="row" alignItems="center">
            <PriceLabel currency={plan.price.currency} value={plan.price.value} description={plan.price.description} />
          </Stack>
  ...
  return (
    <>
      <Grid container>
        ...
        <Grid item xs={3}>
          <OptionPlane title={'客房類型'} options={['雙人床房', '雙床房', '套房']} />
        </Grid>
        <Grid item xs={3}>
        ...
        <Grid item xs={3}>
          <OptionPlane title={'住宿計劃優惠'} options={['俱樂部樓層／俱樂部休息室']} />
        </Grid>
      </Grid>
    </>
  );
      ...
      <div {...props}>
        <Box sx={{ width: '100%' }}>
          ...
          <TabPanel value={value} index={0}>
            ...
            >
              <ButtonGroup aria-label="outlined primary button group" disableElevation fullWidth>
                <Button
                  variant="contained"
                  color="secondary"
                  sx={{
                ...
                >
                  <CalendarMonthIcon sx={{ fontSize: '2rem', color: color.textColor6 }} />
                  <div
                    style={{
                      paddingLeft: '0.3rem',
                      display: 'flex',
                  ...
                  >
                    ...
                    <Typography variant="h6" fontWeight="bold" sx={{ fontSize: '1.2rem', color: color.textColor6 }}>
                      11/1/2023
                    </Typography>
                  </div>
                </Button>
            ...
            <Box sx={{ width: '100%' }}>
              <Stack direction="row">
                <Box sx={{ flexGrow: 4 }}>
                  評分和評價 5 Exceptional 來自認證住客的 24 則評價 地點 4.8 設施與設備 4.9 服務與工作人員 5
                  舒適與整潔度 5 沐浴 4.8 餐飲 4.7
                </Box>
                <Box sx={{ flexGrow: 6 }}>
                  card list 排序 最近期 評價分數 所有評分 Anonymous | Japan 日本 |年齡：50-59 歲 | 親子共遊 5
                  發布日：3/1/2023 今回年末年始で4連泊したのですが、
                  ...
                  ありがとうございました。 また今度は夏休みにリピートしたいです。 回報 有幫助 翻譯 顯示更多 1 2 3 24
                  項中的 1 - 10 項評價
                </Box>
              </Stack>
            </Box>
