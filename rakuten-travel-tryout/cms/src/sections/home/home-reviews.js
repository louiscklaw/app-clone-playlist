...
const QuotesIcon = () => (
  <svg fill="none" height="79" viewBox="0 0 105 79" width="105" xmlns="http://www.w3.org/2000/svg">
    ...
    <defs>
      <clipPath id="clip0_17690_94764">
        <rect fill="white" height="78.0005" transform="translate(0 0.889771)" width="105" />
      </clipPath>
    </defs>
  </svg>
);
      ...
      <Stack spacing={8} sx={{ py: '120px' }}>
        <Stack spacing={2}>
          ...
          <Typography align="center" color="text.secondary" variant="subtitle1">
            Our template is so simple that people can’t help but fall in love with it. Simplicity is easy when you just
            ...
            <Grid key={index} xs={12} md={6} lg={4}>
              <Card sx={{ height: '100%' }}>
                ...
                >
                  ...
                  <div>
                    <Rating readOnly sx={{ color: 'success.main' }} value={review.stars} />
                  </div>
                  <Typography
                    sx={{
                      flexGrow: 1,
