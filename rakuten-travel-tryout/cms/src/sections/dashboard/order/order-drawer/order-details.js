  ...
  return (
    <Stack spacing={6}>
      <Stack spacing={3}>
        ...
        <PropertyList>
          <PropertyListItem align={align} disableGutters divider label="ID" value={order.id} />
          <PropertyListItem align={align} disableGutters divider label="Number" value={order.number} />
          ...
          <PropertyListItem align={align} disableGutters divider label="Promotion Code" value={order.promotionCode} />
          <PropertyListItem align={align} disableGutters divider label="Total Amount" value={totalAmount} />
