...
import { Box, Card, CardHeader, Divider, Input, Stack, SvgIcon, Unstable_Grid2 as Grid } from '@mui/material';
  ...
  return (
    <Card {...other}>
      ...
      >
        ...
        <Box sx={{ flexGrow: 1 }}>
          <Input disableUnderline fullWidth onChange={onQueryChange} placeholder="Search connections" value={query} />
        </Box>
      </Stack>
      <Divider />
      <Box sx={{ p: 3 }}>
