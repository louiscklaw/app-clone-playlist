...
import { Avatar, Box, Card, CardContent, CardMedia, Chip, Link, Stack, Typography } from '@mui/material';
...
export const PostCard = props => {
  ...
  return (
    <Card {...other}>
      <CardMedia component={NextLink} href={paths.dashboard.blog.postDetails} image={cover} sx={{ height: 280 }} />
      <CardContent>
        <Box sx={{ mb: 2 }}>
          <Chip label={category} />
        </Box>
        <Link color="text.primary" component={NextLink} href={paths.dashboard.blog.postDetails} variant="h5">
          {title}
        </Link>
        <Typography
