...
import { Avatar, Box, LinearProgress, Stack, Step, StepLabel, Stepper, SvgIcon, Typography } from '@mui/material';
    ...
    <Avatar
      sx={{
        ...
        ...(highlight
          ...
          : {
              backgroundColor: theme => (theme.palette.mode === 'dark' ? 'neutral.700' : 'neutral.400'),
              color: 'common.white',
            }),
      }}
      variant="circular"
