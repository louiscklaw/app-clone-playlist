...
import { Box, Button, Card, CardContent, Divider, Stack, SvgIcon, Typography } from '@mui/material';
        ...
        <Stack divider={<Divider />} spacing={2}>
          <Stack alignItems="flex-start" direction="row" spacing={2}>
            ...
            <div>
              ...
              <Box sx={{ mt: 2 }}>
                <Button endIcon={<ChevronRightIcon />} size="small" variant="contained">
                  Find Courses
                </Button>
              </Box>
            </div>
          ...
          <Stack alignItems="flex-start" direction="row" spacing={2}>
            ...
            <div>
              ...
              <Box sx={{ mt: 2 }}>
                <Button color="info" endIcon={<ChevronRightIcon />} size="small" variant="contained">
                  Find Tutors
                </Button>
              </Box>
            </div>
