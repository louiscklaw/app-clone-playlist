    ...
    <div>
      ...
      <Stack spacing={3} sx={{ p: 3 }}>
            ...
            <Scrollbar sx={{ maxHeight: 200 }}>
              ...
              >
                {customers.map(customer => {
                  ...
                  return (
                    <FormControlLabel
                      control={<Checkbox checked={isChecked} onChange={handleCustomerToggle} />}
                      key={customer}
                      label={customer}
                      value={customer}
                    />
        ...
        <FormControlLabel
          ...
          label="Paid only"
        />
        <FormControlLabel control={<Switch checked={group} onChange={onGroupChange} />} label="Group by status" />
      </Stack>
    </div>
  );
