...
import { Avatar, Box, Card, LinearProgress, Stack, SvgIcon, Typography, Unstable_Grid2 as Grid } from '@mui/material';
        ...
        <Card>
          <Stack spacing={1} sx={{ p: 3 }}>
            ...
            <Stack alignItems="center" direction="row" spacing={1}>
              ...
              <LinearProgress color="primary" sx={{ flexGrow: 1 }} value={74} variant="determinate" />
            </Stack>
          </Stack>
        </Card>
      </Grid>
