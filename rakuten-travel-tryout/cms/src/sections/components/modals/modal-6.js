...
import { Box, Button, Divider, ListItemIcon, ListItemText, MenuItem, Paper, SvgIcon, Typography } from '@mui/material';
    ...
    <Paper elevation={12} sx={{ maxWidth: 320, mx: 'auto' }}>
      ...
      <Box sx={{ mt: 2 }}>
        <MenuItem>
          ...
          <ListItemText primary={<Typography variant="subtitle2">Profile</Typography>} />
        </MenuItem>
        <MenuItem>
          <ListItemIcon>
            <SvgIcon>
