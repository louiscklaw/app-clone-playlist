          ...
          return (
            ...
            >
              <FormControlLabel
                ...
                label={
                  <Box sx={{ ml: 2 }}>
                    <Typography sx={{ color: isDisabled ? 'action.disabled' : 'text.primary' }} variant="subtitle2">
                      {option.title}
                    </Typography>
                    <Typography sx={{ color: isDisabled ? 'action.disabled' : 'text.secondary' }} variant="body2">
                      {option.description}
                    </Typography>
                  </Box>
                }
