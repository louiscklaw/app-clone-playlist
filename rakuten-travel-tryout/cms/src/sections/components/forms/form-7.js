import { Box, Button, Link, OutlinedInput, Typography, Unstable_Grid2 as Grid } from '@mui/material';
...
export const Form7 = () => (
  <Box sx={{ p: 3 }}>
    <form onSubmit={event => event.preventDefault()}>
      ...
      <Typography align="center" color="text.secondary" sx={{ mt: 2 }} variant="body2">
