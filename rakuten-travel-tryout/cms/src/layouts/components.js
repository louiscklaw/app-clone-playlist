...
import { Box, Breadcrumbs, Container, Divider, Link, Stack, SvgIcon, Typography } from '@mui/material';
              ...
              <div>
                <Breadcrumbs separator={<BreadcrumbsSeparator />}>
                  {breadcrumbs.map((item, index) => {
                    ...
                    return (
                      <Link color="text.primary" component={NextLink} href={item.href} key={index} variant="subtitle2">
                        {item.title}
                      </Link>
                    );
                  })}
